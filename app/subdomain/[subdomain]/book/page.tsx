...
import { SubdomainBookingPage } from "@/components/website-builder/subdomain-booking-page"
...
export default function BookPage() {
  ...
  return (
    <SubdomainBookingPage
      ...
      subdomain={subdomain}
      preselectedServiceId={preselectedServiceId ? parseInt(preselectedServiceId) : undefined}
    />
  )
}
